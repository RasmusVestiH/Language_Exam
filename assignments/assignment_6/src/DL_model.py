...
def main():
    ...
    model.summary()
    # Save model summary
    plot_model(model, to_file = "../output/DL_model_structure.png", show_shapes=True, show_layer_names=True)
    ...
    txt_file = open("../output/DL_model_result.txt", "a")
    txt_file.write(classification_report(y_test,
