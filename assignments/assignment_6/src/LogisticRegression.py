...
def plot_history(H, epochs):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("../output/LR_model.png")
    plt.show()
...
def main():
    ...
    txt_file = open("../output/LR_model_result.txt", "a")
    txt_file.write(metrics.classification_report(y_test, y_pred))
    txt_file.close()


    clf.plot_cm(y_test, y_pred, normalized=True)
    plt.savefig('../output/LR_plot.png')
